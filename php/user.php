        ...
        <div class="card text-center">
            <div class="card-header">
                ...
                <div class="from-group row">
                    ...
                    <div class="col">
                        <button type="button" class="btn btn-success" onclick="location.href='user_add.php'">+ เพิ่มข้อมูล</button>
                    </div>
                </div>
            </div>
            <div class="card-body">
                ...
                <table class="table table-striped custab" id="myTable" style="margin-top: 5px; margin-bottom: 5px;">
                    <thead>
                        ...
                        <tr>
                            <td width="5%">#</td>
                            <td width="12%">เลขห้อง</td>
                            <td width="12%">ชื่อ</td>
                            <td width="12%">นามสกุล</td>
                            <td width="5%">เบอร์โทร</td>
                            <td width="12%">รหัสบัตรประชาชน</td>
                        ...
                        <form action="edit.php" method="post">
                            ...
                            while ($row = $result->fetch_assoc()) : ?>
                                <tr>
                                    ...
                                    <td class="name">
                                        <?php echo $row['national_id']; ?></td>



                                    <td class="text-center">
                                        <a class='btn btn-warning btn-xs' href='edit.php?id=<?php echo $row["id"]; ?>'>แก้ไข</a>

                                        <a class="btn btn-danger btn-xs" href='user_del.php?id=<?php echo $row["id"]; ?>'>ลบ</a>
