        ...
        <div class="card text-center">
            <div class="card-header">
                ...
                <div class="from-group row">
                    ...
                    <div class="col">
                        <button type="button" class="btn btn-success" onclick="location.href='receipt_add.php'">+ เพิ่มค่าเช่า</button>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <table class="table table-striped custab" id="myTable" style="margin-top: 5px; margin-bottom: 5px;">
                    <thead>
                        ...
                        <tr>
                            ...
                            <td width="12%">ค่าไฟ</td>
                            <td width="12%">ค่าน้ำ</td>
                            <td width="12%">ค่าห้อง</td>
                            <td width="12%">จ่ายมาแล้ว</td>
                            <td width="12%">รวมทั้งหมด</td>
                    ...
                    <tbody>
                        <form action="receipt_edit.php" method="post">
                            ...
                            while ($row = $result->fetch_assoc()) : ?>
                                <tr>
                                    ...
                                    <td class="name">
                                        <?php echo $row['received_payment']; ?></td>


                                    <td class="name">
                                        <?php echo $row['elect'] + $row['water'] + $row['room_rate'] - $row['received_payment']; ?></td>

                                    <td class="name">
                                        <?php echo $row['status_payment']; ?></td>

                                    <td class="edit">
                                        <a class='btn btn-warning btn-xs' href='receipt_edit.php?id=<?php echo $row["id"]; ?>'>แก้ไข</a>

                                        <a class="btn btn-danger btn-xs" href='receipt_del.php?id=<?php echo $row["id"]; ?>'>ลบ</a>
                                    </td>
                                </tr>
                            <?php
                                $number_id++;
